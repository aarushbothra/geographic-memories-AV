...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 242.1875, 1910.9375, 29.5, 20.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 376.5625, 1943.75, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 142.1875, 1906.25, 29.5, 20.0 ],
					"text" : "t b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 151.5625, 2106.25, 87.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 142.1875, 1873.4375, 174.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.5625, 2101.5625, 97.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 360.9375, 1989.0625, 130.0, 110.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 638.461569666862488, 1971.428667783737183, 29.5, 20.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 773.626411437988281, 2005.494603514671326, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 539.120000000000005, 1967.0, 29.5, 20.0 ],
					"text" : "t b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 548.351675152778625, 2168.131974101066589, 93.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 539.120000000000005, 1935.164929747581482, 174.0, 20.0 ],
					"text" : "OSC-route /master/level /master/max"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 349.450566530227661, 1826.37371563911438, 79.0, 20.0 ],
					"text" : "OSC-route /1 /2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 674.0, 2162.813288807868958, 97.0, 20.0 ],
					"text" : "/source/1/azim $1"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 758.0, 2050.813288807868958, 130.0, 110.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 534.375, 2236.967142105102539, 65.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 471.428594470024109, 2280.219891667366028, 163.0, 20.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 456.5, 2204.6875, 63.0, 20.0 ],
					"text" : "mc.unpack~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 312.5, 2236.967142105102539, 65.0, 20.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 21.703301429748535, 2060.9375, 150.0, 96.0 ],
					"text" : "1 - FL\n2 - FR \n3 FC\n4 SUB\n5 L\n6 - R\n7 - LR\n8 - RR"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 8,
					"numoutlets" : 0,
					"patching_rect" : [ 272.527485847473145, 2353.846268892288208, 212.934059381484985, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 8,
					"outlettype" : [ "signal", "signal", "signal", "signal", "signal", "signal", "signal", "" ],
					"patching_rect" : [ 274.725288152694702, 2280.219891667366028, 163.0, 20.0 ],
					"saved_object_attributes" : 					{
						"parameter_enable" : 0
					}
,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 61.538464546203613, 2187.912194848060608, 71.0, 40.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 110.98901641368866, 2268.131978988647461, 31.0, 20.0 ],
					"text" : "open"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 98.901103734970093, 2232.967142105102539, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 164.0625, 2208.0, 50.549453020095825, 29.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_linecount" : 2,
					"presentation_rect" : [ 1096.0, 265.0, 47.0, 31.0 ],
					"text" : "0.436558"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "signal" ],
					"patching_rect" : [ 235.9375, 2188.989119052886963, 63.0, 20.0 ],
					"text" : "mc.unpack~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 215.384625911712646, 2253.846264004707336, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-166::obj-10" : [ "live.numbox[2]", "live.numbox", 0 ],
			"obj-166::obj-15" : [ "live.numbox[1]", "live.numbox", 0 ],
			"obj-166::obj-19" : [ "live.numbox[3]", "live.numbox", 0 ],
			"obj-166::obj-3" : [ "live.tab", "live.tab", 0 ],
			"obj-166::obj-7" : [ "live.numbox", "live.numbox", 0 ],
			"obj-185::obj-10" : [ "live.numbox[6]", "live.numbox", 0 ],
			"obj-185::obj-15" : [ "live.numbox[7]", "live.numbox", 0 ],
			"obj-185::obj-19" : [ "live.numbox[5]", "live.numbox", 0 ],
			"obj-185::obj-3" : [ "live.tab[1]", "live.tab", 0 ],
			"obj-185::obj-7" : [ "live.numbox[4]", "live.numbox", 0 ],
...
,
		"dependency_cache" : [ 			{
				...
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/media",
...
, 			{
				"name" : "Time Bomb Vintage_Anxiety.wav",
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/media",
				"patcherrelativepath" : "../media",
				"type" : "WAVE",
				"implicit" : 1
...
, 			{
				"name" : "Time Bomb Vintage_Averaged.wav",
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/media",
				"patcherrelativepath" : "../media",
				"type" : "WAVE",
				"implicit" : 1
...
, 			{
				"name" : "Time Bomb Vintage_Isolated.wav",
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/media",
				"patcherrelativepath" : "../media",
				"type" : "WAVE",
				"implicit" : 1
...
, 			{
				"name" : "Time Bomb Vintage_field recording.wav",
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/media",
				"patcherrelativepath" : "../media",
				"type" : "WAVE",
				"implicit" : 1
...
, 			{
				"name" : "hennepin county governement center_anxiety.wav",
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/media",
				"patcherrelativepath" : "../media",
				"type" : "WAVE",
				"implicit" : 1
...
, 			{
				"name" : "hennepin county governement center_averaged.wav",
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/media",
				"patcherrelativepath" : "../media",
				"type" : "WAVE",
				"implicit" : 1
...
, 			{
				"name" : "hennepin county governement center_field recording.wav",
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/media",
				"patcherrelativepath" : "../media",
				"type" : "WAVE",
				"implicit" : 1
...
, 			{
				...
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/patchers",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
...
, 			{
				...
				"bootpath" : "~/Documents/Max 9/Projects/geographic_memories/code",
...
, 			{
				...
				"patcherrelativepath" : "../../../Packages/spat5/javascript",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
...
, 			{
				...
				"patcherrelativepath" : "../../../Packages/spat5/extras",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
